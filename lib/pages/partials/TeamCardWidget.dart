...
class TeamCardWidget extends StatefulWidget {
  TeamCardWidget(this._team,{Key key}) : super(key: key);
...
class _TeamCardWidgetState extends State<TeamCardWidget> {
  ...
  void _handleTeamTap() {
    ...
    Navigator.of(context).push(new MaterialPageRoute(
      builder: (BuildContext context) => new TeamHomePage(widget._team.getId(), widget._team.getName()),
    ));
  }

  void _handleLeagueHomeTap() {
    Navigator.of(context).push(new MaterialPageRoute(
      builder: (BuildContext context) => new LeagueHomePage(widget._team.getLeague().getId(), widget._team.getLeague().getName()),
    ));
  }
